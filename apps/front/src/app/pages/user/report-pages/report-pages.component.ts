 ...
 *
 * The AI draft integration (radiogenia) was removed in Sprint 0; the rich
 * editor stays so radiologists can still write reports by hand while the
 * Sprint 5 editor is built.
 */
@Component({
